...
public class SecondaryAnalysisOutputTestInformationAggregator implements ArgumentsAggregator {
    ...
    public Object aggregateArguments(ArgumentsAccessor argumentsAccessor, ParameterContext parameterContext)
        ...
        List<SecondaryAnalysisOutputTestInformation> testInformationArrayList = new ArrayList<>();
        ...
        for (int modelIndex = 0; modelIndex < modelsInTestCase; ++modelIndex) {
            ...
            testInformationArrayList.add(new SecondaryAnalysisOutputTestInformation()
