...
public class TertiaryAnalysisOutputTestInformation {
    ...
    public TertiaryAnalysisOutputTestInformation withBpSeqSize(int bpSeqSize) {
        this.bpSeqSize = bpSeqSize;
        return this;
    }

    public TertiaryAnalysisOutputTestInformation withCtSize(int ctSize) {
        this.ctSize = ctSize;
        return this;
    }

    public TertiaryAnalysisOutputTestInformation withStructuralElementStemsSize(int structuralElementStemsSize) {
        this.structuralElementStemsSize = structuralElementStemsSize;
        return this;
    }

    public TertiaryAnalysisOutputTestInformation withStructuralElementSLoopsSize(int structuralElementSLoopsSize) {
        this.structuralElementSLoopsSize = structuralElementSLoopsSize;
        return this;
    }

    public TertiaryAnalysisOutputTestInformation withStructuralElementSingleStrandsSize(int structuralElementSingleStrandsSize) {
        this.structuralElementSingleStrandsSize = structuralElementSingleStrandsSize;
        return this;
    }

    public TertiaryAnalysisOutputTestInformation withStructuralElementSingleStrands5pSize(int structuralElementSingleStrands5pSize) {
        this.structuralElementSingleStrands5pSize = structuralElementSingleStrands5pSize;
        return this;
    }

    public TertiaryAnalysisOutputTestInformation withStructuralElementSingleStrands3pSize(int structuralElementSingleStrands3pSize) {
        this.structuralElementSingleStrands3pSize = structuralElementSingleStrands3pSize;
        return this;
    }

    public TertiaryAnalysisOutputTestInformation withCoordinatesLineLength(int coordinatesLineLength) {
        this.coordinatesLineLength = coordinatesLineLength;
        return this;
    }

    public TertiaryAnalysisOutputTestInformation withMessagesSize(int messagesSize) {
        this.messagesSize = messagesSize;
        return this;
    }

    public TertiaryAnalysisOutputTestInformation withCanonicalInteractionsSize(int canonicalInteractionsSize) {
    ...
    public TertiaryAnalysisOutputTestInformation withStackingInteractionsSize(int stackingInteractionsSize) {
        this.stackingInteractionsSize = stackingInteractionsSize;
        return this;
    }

    public TertiaryAnalysisOutputTestInformation withBasePhosphateInteractionsSize(int basePhosphateInteractionsSize) {
        this.basePhosphateInteractionsSize = basePhosphateInteractionsSize;
        return this;
    }

    public TertiaryAnalysisOutputTestInformation withBaseRiboseInteractionsSize(int baseRiboseInteractionsSize) {
