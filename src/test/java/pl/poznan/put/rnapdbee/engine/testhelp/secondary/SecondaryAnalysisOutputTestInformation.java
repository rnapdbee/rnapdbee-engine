package pl.poznan.put.rnapdbee.engine.testhelp.secondary;

public class SecondaryAnalysisOutputTestInformation {
    ...
    public SecondaryAnalysisOutputTestInformation withBpSeqSize(int bpSeqSize) {
        this.bpSeqSize = bpSeqSize;
        return this;
    }

    public SecondaryAnalysisOutputTestInformation withCtEntriesSize(int ctEntriesSize) {
    ...
    public SecondaryAnalysisOutputTestInformation withInteractionsSize(int interactionsSize) {
        this.interactionsSize = interactionsSize;
        return this;
    }

    public SecondaryAnalysisOutputTestInformation withStructuralElementStemsSize(int structuralElementStemsSize) {
        this.structuralElementStemsSize = structuralElementStemsSize;
        return this;
    }

    public SecondaryAnalysisOutputTestInformation withStructuralElementSLoopsSize(int structuralElementSLoopsSize) {
        this.structuralElementSLoopsSize = structuralElementSLoopsSize;
        return this;
    }

    public SecondaryAnalysisOutputTestInformation withStructuralElementSingleStrandsSize(int structuralElementSingleStrandsSize) {
        this.structuralElementSingleStrandsSize = structuralElementSingleStrandsSize;
        return this;
    }

    public SecondaryAnalysisOutputTestInformation withStructuralElementSingleStrands5pSize(int structuralElementSingleStrands5pSize) {
        this.structuralElementSingleStrands5pSize = structuralElementSingleStrands5pSize;
        return this;
    }

    public SecondaryAnalysisOutputTestInformation withStructuralElementSingleStrands3pSize(int structuralElementSingleStrands3pSize) {
