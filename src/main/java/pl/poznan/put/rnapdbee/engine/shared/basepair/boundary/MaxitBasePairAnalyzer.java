...
@Component
public class MaxitBasePairAnalyzer extends BasePairAnalyzer {

    @Override
    public AnalysisTool analysisTool() {
        return AnalysisTool.MAXIT;
    }

    @Override
    @Cacheable("AnalysisMaxit")
    ...
    @Autowired
    public MaxitBasePairAnalyzer(RnaPDBeeAdaptersCaller rnaPDBeeAdaptersCaller) {
