...
public class DrawerVarnaTz implements SecondaryStructureDrawer {
    ...
    @Override
    public final SVGDocument drawSecondaryStructure(final DotBracket dotBracket, List<? extends ClassifiedBasePair> stacking)
    ...
    public final SVGDocument drawSecondaryStructure(
            ...
            final List<? extends ClassifiedBasePair> nonCanonicalBasePairs, List<? extends ClassifiedBasePair> stacking)
            throws VisualizationException {
